    ...
    extends RuntimeException
{
    ...
    public ConditionParserException(final String msg, final Throwable cause) {
        super(msg, cause);
    }

    public ConditionParserException(final String msg) {
        super(msg);
    }

    public ConditionParserException(final Throwable cause) {
        super(cause);
    }
}
