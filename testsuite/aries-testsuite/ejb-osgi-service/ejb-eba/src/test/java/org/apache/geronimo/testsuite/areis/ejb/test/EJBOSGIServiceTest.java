 ...
 */
package org.apache.geronimo.testsuite.areis.ejb.test;
 ...
 */
public class EJBOSGIServiceTest extends TestSupport{
    private String baseURL = "http://localhost:8080/";

    @Test
    public void testServlet() throws Exception {
        checkReply("/EJBServlet");
    }
    ...
    private void checkReply(String address)
        ...
        assertTrue("EJB as OSGI Service", 
