...
public class DatabaseInfo {
     ...
     */
    private final static String TRANQL_RAR_NAME = "tranql/tranql-connector/1.2/rar";
    private final static String DERBY_EMBEDDED_LOCAL_RAR_NAME = "tranql/tranql-connector-derby-embed-local/1.1/rar";
    private final static String DERBY_NETWORK_LOCAL_RAR_NAME = "tranql/tranql-connector-derby-client-local/1.1/rar";
    private final static String DERBY_EMBEDDED_XA_RAR_NAME = "tranql/tranql-connector-derby-embed-xa/1.1/rar";
    private final static String DERBY_NETWORK_XA_RAR_NAME = "tranql/tranql-connector-derby-client-xa/1.1/rar";
    ...
    public static final DatabaseInfo[] ALL_DATABASES = new DatabaseInfo[]{
            ...
            new DatabaseInfo("Derby embedded", DERBY_EMBEDDED_LOCAL_RAR_NAME),
            new DatabaseInfo("Derby network", DERBY_NETWORK_LOCAL_RAR_NAME),
            new DatabaseInfo("Derby embedded XA", DERBY_EMBEDDED_XA_RAR_NAME),
            new DatabaseInfo("Derby network XA", DERBY_NETWORK_XA_RAR_NAME),
