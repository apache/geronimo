...
public class MIMEOutputStream extends OutputStream {
    ...
    // a flag to indicate we've just processed a line break.  This is used for byte stuffing purposes.  This
    // is initially true, because if the first character of the content is a period, we need to byte-stuff
    // immediately.
    ...
    public void write(int ch) throws IOException {
        // if this is a CR character, always write out a full sequence, and remember that we just did this.
        if (ch == '\r') {
            out.write((byte)'\r');
            out.write((byte)'\n');
        ...
        // if this is a new line, then we need to determine if this is a loner or part of a CRLF sequence.
        else if (ch == '\n') {
        ...
        // potential byte-stuffing situation?
            ...
            // ok, this is a potential stuff situation.  Did we just have a line break?  Double up the character.
            if (atLineBreak) {
                out.write('.');
            }
            out.write('.');
