...
public class SMTPTransport extends Transport {
    ...
    public class SendStatus {
         ...
         * @param a      The address this is the status for.
         * @param c      The command string associated with this status.
         * @param r      The reply information from the server.
         */
         ...
         *
         * @return The command string for the MAIL TO command sent to the server.
         */
         ...
         * There is a mechanism for reporting send success via a send
         * operation, so this will be either a success or failure
         * exception.
         *
         * @param reportSuccess
