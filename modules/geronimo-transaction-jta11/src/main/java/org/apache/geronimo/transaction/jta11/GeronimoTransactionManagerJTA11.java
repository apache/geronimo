 ...
 * @version $Rev$ $Date$
 */
public class GeronimoTransactionManagerJTA11 extends GeronimoTransactionManager implements TransactionSynchronizationRegistry {
    ...
    public GeronimoTransactionManagerJTA11(int defaultTransactionTimeoutSeconds, TransactionLog transactionLog) throws XAException {
