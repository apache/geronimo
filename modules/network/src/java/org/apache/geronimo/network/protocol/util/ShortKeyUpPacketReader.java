 ...
 */
public class ShortKeyUpPacketReader implements PacketReader {

    static protected Map factories = new HashMap();

    public static void register(Short key, PacketFactory factory) {
        factories.put(key, factory);
    }

    public UpPacket read(ByteBuffer buffer) throws ProtocolException {
        Short key = new Short(buffer.getShort());
