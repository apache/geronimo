 ...
 */
class BootSuccessUpPacket extends ByteKeyUpPacket implements PacketFactory {

    public BootSuccessUpPacket() {
        super(AbstractControlProtocol.BOOT_SUCCESS);
    }

    public UpPacket create(ByteBuffer buffer) throws ProtocolException {

        return new BootSuccessUpPacket();
    }
