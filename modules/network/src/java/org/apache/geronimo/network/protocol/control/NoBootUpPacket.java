 ...
 */
class NoBootUpPacket extends ByteKeyUpPacket implements PacketFactory {

    public NoBootUpPacket() {
        super(AbstractControlProtocol.NOBOOT);
    }

    public UpPacket create(ByteBuffer buffer) throws ProtocolException {
        return new NoBootUpPacket();
    }
}
