 ...
 * @version $Rev$ $Date$
 */
class PassthroughUpPacket extends ByteKeyUpPacket implements PacketFactory {

    public PassthroughUpPacket() {
        super(AbstractControlProtocol.PASSTHROUGH);
    }

    public UpPacket create(ByteBuffer buffer) throws ProtocolException {
        PassthroughUpPacket packet = new PassthroughUpPacket();
