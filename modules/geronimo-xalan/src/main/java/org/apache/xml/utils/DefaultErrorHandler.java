 ...
 */
/*
 * $Id: DefaultErrorHandler.java 338167 2005-06-03 15:52:46Z mkwan $
 */
 ...
 * This modifies the DefaultErrorHandler in xalan 2.7 to make it NOT JAXP 1.3 COMPLIANT
 * To restore jaxp 1.3 behavior set the system property org.apache.geronimo.xalan.jaxp.13.compliant=true
 * @xsl.usage general
 */
public class DefaultErrorHandler implements ErrorHandler, ErrorListener
{
   ...
   */
  private static final boolean m_throwExceptionOnError;

    static {
        boolean compliant = Boolean.getBoolean("org.apache.geronimo.xalan.jaxp.13.compliant");
        m_throwExceptionOnError = !compliant;
    }
  ...
  public DefaultErrorHandler(boolean throwExceptionOnError)
  {
    m_pw = new PrintWriter(System.err, true);
      //THIS MODIFIES THE NORMAL XALAN BEHAVIOR
