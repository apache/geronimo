...
public final class ConfirmMessageTag extends TagSupport {
    ...
    private static final String DOJO_BASE = "/console/dojo";
    ...
    public int doStartTag() throws JspException {
        ...
        try {
            ...
            out.println("@import \"" + DOJO_BASE + "/dijit/themes/claro/claro.css\";");
            out.println("@import \"" + DOJO_BASE + "/dojo/resources/dojo.css\";");
            out.println(".claro .dijitDialog {background:#F7F7F7; border:3px solid #88A4D7; width:450px; padding:10px; font-family:Verdana,Helvetica,sans-serif;}");
            out.println(".claro .dijitDialog .dijitDialogPaneContent {background:#F7F7F7; border:0; padding:0;}");
            out.println(".claro .dijitDialogUnderlay {background:#000000; opacity:0.5;}");
