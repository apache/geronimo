 ...
 * 1) support for skipped state (for periodic tasks)
 * 2) support for taskStart() and taskDone() callbacks 
 */
...
public class FutureTask<V> implements Future<V>, Runnable {
    ...
    public boolean isSkipped() {
        return sync.innerIsSkipped();
    }
    
    protected boolean setSkipped() {
        return sync.innerSetSkipped();
    }
    ...
    private final class Sync extends AbstractQueuedSynchronizer {
        ...
        private static final int SKIPPED   = 8;
        ...
        protected int tryAcquireShared(int ignore) {
            return (innerIsDone() || innerIsSkipped()) ? 1 : -1;
        }
