...
public class AdvancedWARWebServiceFinder implements WebServiceFinder {
    ...
    private static final Log LOG = LogFactory.getLog(AdvancedWARWebServiceFinder.class);
            ...
            for (Class service : services) {
                ...
                if (mappedServlets == null) {
                    ...
                    for (String servlet : mappedServlets) {
                        LOG.debug("POJO Web Service class " + service.getName() + " is mapped to " + servlet + " servlet");
